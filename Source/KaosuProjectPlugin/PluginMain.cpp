...
//============================================================================================================
class KaosuProjectPluginClass : public IVisPlugin_cl
{
public:
  ...
  {
    return "KaosuProjectPlugin";  // must match DLL name
  }
};

//  global plugin instance
KaosuProjectPluginClass g_myComponents;
...
//--------------------------------------------------------------------------------------------
VEXPORT IVisPlugin_cl* GetEnginePlugin_KaosuProjectPlugin(){  return &g_myComponents; }


#if (defined _DLL) || (defined _WINDLL)

  //  The engine uses this to get and initialize the plugin dynamically
  VEXPORT IVisPlugin_cl* GetEnginePlugin(){return GetEnginePlugin_KaosuProjectPlugin();}
...
void KaosuProjectPluginClass::OnInitEnginePlugin()
{
  hkvLog::Info("KaosuProjectPluginClass:OnInitEnginePlugin()");
...
// load plugins if supported
  ...
  kBaseComponent_ComponentManager::GlobalManager().OneTimeInit();
  // [...]
...
void KaosuProjectPluginClass::OnDeInitEnginePlugin()
{
  hkvLog::Info("KaosuProjectPluginClass:OnDeInitEnginePlugin()");
    
  // Close our component managers here....
  kBaseComponent_ComponentManager::GlobalManager().OneTimeDeInit();
